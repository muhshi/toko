    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        @endif
          ...
          {{ Form::open(array('action' => 'TokoController@store', 'enctype' => "multipart/form-data", 'novalidate', 'class' => 'form-horizontal form-label-left' )) }}
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="nama_toko" class="form-control col-md-7 col-xs-12" data-validate-length-range="3" name="nama_toko" placeholder="misal: Toko Baju" required="required" type="text">
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="no_hp" class="form-control col-md-7 col-xs-12" name="no_hp" required="required" type="tel">
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea class="form-control col-md-7 col-xs-12" name="alamat_toko" required="required">  </textarea>   
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="tagline" class="form-control col-md-7 col-xs-12" name="tagline" type="text">
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="tagline" class="form-control col-md-7 col-xs-12" name="facebook" type="text">
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="twitter" class="form-control col-md-7 col-xs-12" name="twitter" type="text">
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="instagram" class="form-control col-md-7 col-xs-12" name="instagram" type="text">
              </div>
            </div>
