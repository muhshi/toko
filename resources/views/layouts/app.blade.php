        ...
        <nav class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <!-- Branding Image -->
                    <span><img src="<?php echo asset('public/images/manajemen.png') ?>" width="40px;" style="margin-top: 10px;"></span>
                    <a class="navbar-brand" href="{{ url('/') }}" style="float: right; margin-left: 3px;" >
                        Manajemen Toko
                    </a>
                </div>
